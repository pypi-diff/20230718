# Comparing `tmp/dwiqc-0.7.0-py2.py3-none-any.whl.zip` & `tmp/dwiqc-0.7.1-py2.py3-none-any.whl.zip`
...
## Comparing `dwiqc-0.7.0.data/scripts/dwiQC.py` & `dwiqc-0.7.1.data/scripts/dwiQC.py`
...
## Comparing `dwiqc-0.7.0.dist-info/LICENSE` & `dwiqc-0.7.1.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `dwiqc-0.7.0.dist-info/RECORD` & `dwiqc-0.7.1.dist-info/RECORD`
