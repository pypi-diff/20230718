# Comparing `tmp/cdk8s-plus-25-2.8.95.tar.gz` & `tmp/cdk8s-plus-25-2.8.96.tar.gz`
...
## Comparing `cdk8s-plus-25-2.8.95.tar` & `cdk8s-plus-25-2.8.96.tar`
...
### Comparing `cdk8s-plus-25-2.8.95/LICENSE` & `cdk8s-plus-25-2.8.96/LICENSE`

 * *Files identical despite different names*

### Comparing `cdk8s-plus-25-2.8.95/PKG-INFO` & `cdk8s-plus-25-2.8.96/PKG-INFO`
...
### Comparing `cdk8s-plus-25-2.8.95/README.md` & `cdk8s-plus-25-2.8.96/README.md`

 * *Files identical despite different names*

### Comparing `cdk8s-plus-25-2.8.95/setup.py` & `cdk8s-plus-25-2.8.96/setup.py`
...
### Comparing `cdk8s-plus-25-2.8.95/src/cdk8s_plus_25/__init__.py` & `cdk8s-plus-25-2.8.96/src/cdk8s_plus_25/__init__.py`

 * *Files identical despite different names*

### Comparing `cdk8s-plus-25-2.8.95/src/cdk8s_plus_25/k8s/__init__.py` & `cdk8s-plus-25-2.8.96/src/cdk8s_plus_25/k8s/__init__.py`

 * *Files identical despite different names*

### Comparing `cdk8s-plus-25-2.8.95/src/cdk8s_plus_25.egg-info/PKG-INFO` & `cdk8s-plus-25-2.8.96/src/cdk8s_plus_25.egg-info/PKG-INFO`
