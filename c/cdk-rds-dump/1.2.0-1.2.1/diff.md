# Comparing `tmp/cdk-rds-dump-1.2.0.tar.gz` & `tmp/cdk-rds-dump-1.2.1.tar.gz`
...
## Comparing `cdk-rds-dump-1.2.0.tar` & `cdk-rds-dump-1.2.1.tar`
...
### Comparing `cdk-rds-dump-1.2.0/LICENSE` & `cdk-rds-dump-1.2.1/LICENSE`

 * *Files identical despite different names*

### Comparing `cdk-rds-dump-1.2.0/PKG-INFO` & `cdk-rds-dump-1.2.1/PKG-INFO`
...
### Comparing `cdk-rds-dump-1.2.0/README.md` & `cdk-rds-dump-1.2.1/README.md`

 * *Files identical despite different names*

### Comparing `cdk-rds-dump-1.2.0/setup.py` & `cdk-rds-dump-1.2.1/setup.py`
...
### Comparing `cdk-rds-dump-1.2.0/src/cdk_rds_dump/__init__.py` & `cdk-rds-dump-1.2.1/src/cdk_rds_dump/__init__.py`

 * *Files identical despite different names*

### Comparing `cdk-rds-dump-1.2.0/src/cdk_rds_dump.egg-info/PKG-INFO` & `cdk-rds-dump-1.2.1/src/cdk_rds_dump.egg-info/PKG-INFO`
