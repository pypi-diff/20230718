# Comparing `tmp/lexsetAPI-3.4.4.tar.gz` & `tmp/lexsetAPI-3.4.5.tar.gz`
...
## Comparing `lexsetAPI-3.4.4.tar` & `lexsetAPI-3.4.5.tar`
...
### Comparing `lexsetAPI-3.4.4/lexsetAPI/LexsetManager.py` & `lexsetAPI-3.4.5/lexsetAPI/LexsetManager.py`
...
### Comparing `lexsetAPI-3.4.4/lexsetAPI/credentials.py` & `lexsetAPI-3.4.5/lexsetAPI/credentials.py`
