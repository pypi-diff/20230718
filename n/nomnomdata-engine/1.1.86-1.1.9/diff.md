# Comparing `tmp/nomnomdata_engine-1.1.86.tar.gz` & `tmp/nomnomdata-engine-1.1.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "nomnomdata_engine-1.1.86.tar", max compression
+gzip compressed data, was "nomnomdata-engine-1.1.9.tar", max compression
```

## Comparing `nomnomdata_engine-1.1.86.tar` & `nomnomdata-engine-1.1.9.tar`

### file list

```diff
@@ -1,17 +1,18 @@
--rw-r--r--   0        0        0      702 2023-07-17 19:40:48.262326 nomnomdata_engine-1.1.86/LICENSE
--rw-r--r--   0        0        0       37 2023-07-17 19:40:48.262326 nomnomdata_engine-1.1.86/README.md
--rw-r--r--   0        0        0      432 2023-07-17 19:40:48.262326 nomnomdata_engine-1.1.86/nomnomdata/engine/__init__.py
--rw-r--r--   0        0        0    10061 2023-07-17 19:40:48.262326 nomnomdata_engine-1.1.86/nomnomdata/engine/components.py
--rw-r--r--   0        0        0    73798 2023-07-17 19:40:48.262326 nomnomdata_engine-1.1.86/nomnomdata/engine/connections.py
--rw-r--r--   0        0        0     5598 2023-07-17 19:40:48.262326 nomnomdata_engine-1.1.86/nomnomdata/engine/encoders.py
--rw-r--r--   0        0        0    14368 2023-07-17 19:40:48.262326 nomnomdata_engine-1.1.86/nomnomdata/engine/engine.py
--rw-r--r--   0        0        0      516 2023-07-17 19:40:48.262326 nomnomdata_engine-1.1.86/nomnomdata/engine/errors.py
--rw-r--r--   0        0        0      290 2023-07-17 19:40:48.262326 nomnomdata_engine-1.1.86/nomnomdata/engine/globals.py
--rw-r--r--   0        0        0     2448 2023-07-17 19:40:48.263326 nomnomdata_engine-1.1.86/nomnomdata/engine/logging.py
--rw-r--r--   0        0        0    11023 2023-07-17 19:40:48.263326 nomnomdata_engine-1.1.86/nomnomdata/engine/nominode.py
--rw-r--r--   0        0        0     9574 2023-07-17 19:40:48.263326 nomnomdata_engine-1.1.86/nomnomdata/engine/parameters.py
--rw-r--r--   0        0        0    35388 2023-07-17 19:40:48.263326 nomnomdata_engine-1.1.86/nomnomdata/engine/shared_configs.py
--rw-r--r--   0        0        0     4357 2023-07-17 19:40:48.263326 nomnomdata_engine-1.1.86/nomnomdata/engine/testing.py
--rw-r--r--   0        0        0      162 2023-07-17 19:40:48.263326 nomnomdata_engine-1.1.86/nomnomdata/engine/util.py
--rw-r--r--   0        0        0     1291 2023-07-17 19:41:01.484682 nomnomdata_engine-1.1.86/pyproject.toml
--rw-r--r--   0        0        0     1131 1970-01-01 00:00:00.000000 nomnomdata_engine-1.1.86/PKG-INFO
...
### Comparing `nomnomdata_engine-1.1.86/LICENSE` & `nomnomdata-engine-1.1.9/LICENSE`

 * *Files identical despite different names*

### Comparing `nomnomdata_engine-1.1.86/nomnomdata/engine/components.py` & `nomnomdata-engine-1.1.9/nomnomdata/engine/components.py`
...
### Comparing `nomnomdata_engine-1.1.86/nomnomdata/engine/encoders.py` & `nomnomdata-engine-1.1.9/nomnomdata/engine/encoders.py`
...
### Comparing `nomnomdata_engine-1.1.86/nomnomdata/engine/engine.py` & `nomnomdata-engine-1.1.9/nomnomdata/engine/engine.py`

 * *Files identical despite different names*

### Comparing `nomnomdata_engine-1.1.86/nomnomdata/engine/errors.py` & `nomnomdata-engine-1.1.9/nomnomdata/engine/errors.py`

 * *Files identical despite different names*

### Comparing `nomnomdata_engine-1.1.86/nomnomdata/engine/logging.py` & `nomnomdata-engine-1.1.9/nomnomdata/engine/logging.py`

 * *Files identical despite different names*

### Comparing `nomnomdata_engine-1.1.86/nomnomdata/engine/nominode.py` & `nomnomdata-engine-1.1.9/nomnomdata/engine/nominode.py`

 * *Files identical despite different names*

### Comparing `nomnomdata_engine-1.1.86/nomnomdata/engine/parameters.py` & `nomnomdata-engine-1.1.9/nomnomdata/engine/parameters.py`

 * *Files identical despite different names*

### Comparing `nomnomdata_engine-1.1.86/nomnomdata/engine/testing.py` & `nomnomdata-engine-1.1.9/nomnomdata/engine/testing.py`

 * *Files identical despite different names*

### Comparing `nomnomdata_engine-1.1.86/pyproject.toml` & `nomnomdata-engine-1.1.9/pyproject.toml`
...
### Comparing `nomnomdata_engine-1.1.86/PKG-INFO` & `nomnomdata-engine-1.1.9/PKG-INFO`
