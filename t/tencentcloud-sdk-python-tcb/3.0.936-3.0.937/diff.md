# Comparing `tmp/tencentcloud-sdk-python-tcb-3.0.936.tar.gz` & `tmp/tencentcloud-sdk-python-tcb-3.0.937.tar.gz`
...
## Comparing `tencentcloud-sdk-python-tcb-3.0.936.tar` & `tencentcloud-sdk-python-tcb-3.0.937.tar`
...
### Comparing `tencentcloud-sdk-python-tcb-3.0.936/setup.py` & `tencentcloud-sdk-python-tcb-3.0.937/setup.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-tcb-3.0.936/tencentcloud/__init__.py` & `tencentcloud-sdk-python-tcb-3.0.937/tencentcloud/__init__.py`
...
### Comparing `tencentcloud-sdk-python-tcb-3.0.936/tencentcloud/tcb/v20180608/errorcodes.py` & `tencentcloud-sdk-python-tcb-3.0.937/tencentcloud/tcb/v20180608/errorcodes.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-tcb-3.0.936/tencentcloud/tcb/v20180608/tcb_client.py` & `tencentcloud-sdk-python-tcb-3.0.937/tencentcloud/tcb/v20180608/tcb_client.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-tcb-3.0.936/tencentcloud/tcb/v20180608/models.py` & `tencentcloud-sdk-python-tcb-3.0.937/tencentcloud/tcb/v20180608/models.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-tcb-3.0.936/tencentcloud_sdk_python_tcb.egg-info/PKG-INFO` & `tencentcloud-sdk-python-tcb-3.0.937/tencentcloud_sdk_python_tcb.egg-info/PKG-INFO`
...
### Comparing `tencentcloud-sdk-python-tcb-3.0.936/PKG-INFO` & `tencentcloud-sdk-python-tcb-3.0.937/PKG-INFO`
...
### Comparing `tencentcloud-sdk-python-tcb-3.0.936/README.rst` & `tencentcloud-sdk-python-tcb-3.0.937/README.rst`
