# Comparing `tmp/talan-0.1.4.tar.gz` & `tmp/talan-0.1.4.4.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "talan-0.1.4.tar", last modified: Wed Oct 12 20:09:31 2022, max compression
+gzip compressed data, was "talan-0.1.4.4.tar", last modified: Tue Jul 18 19:12:46 2023, max compression
```

## Comparing `talan-0.1.4.tar` & `talan-0.1.4.4.tar`

### file list

```diff
@@ -1,42 +1,44 @@
-drwxr-xr-x   0 rstudio   (1001) users      (100)        0 2022-10-12 20:09:31.572888 talan-0.1.4/
--rw-r--r--   0 rstudio   (1001) users      (100)      686 2022-10-12 20:09:31.572888 talan-0.1.4/PKG-INFO
--rw-r--r--   0 rstudio   (1001) users      (100)      314 2021-10-14 21:05:42.000000 talan-0.1.4/README.md
--rw-r--r--   0 rstudio   (1001) users      (100)       38 2022-10-12 20:09:31.572888 talan-0.1.4/setup.cfg
--rw-r--r--   0 rstudio   (1001) users      (100)      973 2022-10-12 20:09:12.000000 talan-0.1.4/setup.py
-drwxr-xr-x   0 rstudio   (1001) users      (100)        0 2022-10-12 20:09:31.568888 talan-0.1.4/talan/
--rw-r--r--   0 rstudio   (1001) users      (100)      238 2022-10-12 20:09:03.000000 talan-0.1.4/talan/__init__.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)    39916 2022-10-10 01:17:35.000000 talan-0.1.4/talan/_alan_calc.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)    13070 2022-08-17 17:29:02.000000 talan-0.1.4/talan/_alan_date.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)    14990 2022-05-09 20:38:57.000000 talan-0.1.4/talan/_alan_mp4.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)    11619 2022-03-30 15:57:05.000000 talan-0.1.4/talan/_alan_ohlc_fcs.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)     4265 2019-08-01 04:14:12.000000 talan-0.1.4/talan/_alan_optparse.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)    14976 2021-10-29 01:15:39.000000 talan-0.1.4/talan/_alan_pppscf.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)    28436 2022-08-19 18:20:19.000000 talan-0.1.4/talan/_alan_rmc.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)    64824 2022-09-16 15:56:48.000000 talan-0.1.4/talan/_alan_str.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)    46272 2022-09-03 17:19:27.000000 talan-0.1.4/talan/alanapi.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)    30625 2022-09-12 18:35:55.000000 talan-0.1.4/talan/csv2plotj2ts.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)     7100 2021-09-19 20:39:01.000000 talan-0.1.4/talan/find_recent_eps.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)     3518 2022-10-12 19:28:21.000000 talan-0.1.4/talan/fredReader.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)     6247 2021-07-31 01:13:30.000000 talan-0.1.4/talan/headline_calc.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)     9876 2020-05-08 19:29:00.000000 talan-0.1.4/talan/headline_sts.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)     6261 2020-05-19 00:26:02.000000 talan-0.1.4/talan/iex_peers.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)    34234 2022-03-30 17:55:59.000000 talan-0.1.4/talan/lsi_daily.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)     9822 2021-09-29 19:06:55.000000 talan-0.1.4/talan/macro_event_yh.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)    40055 2022-06-07 20:46:02.000000 talan-0.1.4/talan/plot_templates.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)     5752 2021-10-11 19:14:52.000000 talan-0.1.4/talan/prc_temp_DN.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)    11228 2020-10-09 14:50:59.000000 talan-0.1.4/talan/record_hilo.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)     1027 2022-10-12 19:27:48.000000 talan-0.1.4/talan/talan_wrap.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)    14131 2020-07-30 21:48:04.000000 talan-0.1.4/talan/theme_list.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)     6123 2021-10-07 16:16:03.000000 talan-0.1.4/talan/ticker2label.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)     6552 2021-10-07 03:41:34.000000 talan-0.1.4/talan/ticker_mapping.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)     4825 2021-10-11 19:44:03.000000 talan-0.1.4/talan/upd_mapping_ticker.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)     6419 2022-10-12 02:41:07.000000 talan-0.1.4/talan/webReader.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)    37434 2022-08-10 16:51:40.000000 talan-0.1.4/talan/yh_chart.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)    15404 2022-06-03 18:37:28.000000 talan-0.1.4/talan/yh_hist_batch.py
--rwxr-xr-x   0 rstudio   (1001) users      (100)     5046 2020-10-29 15:32:34.000000 talan-0.1.4/talan/yh_predefined.py
-drwxr-xr-x   0 rstudio   (1001) users      (100)        0 2022-10-12 20:09:31.572888 talan-0.1.4/talan.egg-info/
--rw-r--r--   0 rstudio   (1001) users      (100)      686 2022-10-12 20:09:31.000000 talan-0.1.4/talan.egg-info/PKG-INFO
--rw-r--r--   0 rstudio   (1001) users      (100)      801 2022-10-12 20:09:31.000000 talan-0.1.4/talan.egg-info/SOURCES.txt
--rw-r--r--   0 rstudio   (1001) users      (100)        1 2022-10-12 20:09:31.000000 talan-0.1.4/talan.egg-info/dependency_links.txt
--rw-r--r--   0 rstudio   (1001) users      (100)       38 2022-10-12 20:09:31.000000 talan-0.1.4/talan.egg-info/requires.txt
--rw-r--r--   0 rstudio   (1001) users      (100)        6 2022-10-12 20:09:31.000000 talan-0.1.4/talan.egg-info/top_level.txt
...
### Comparing `talan-0.1.4/PKG-INFO` & `talan-0.1.4.4/PKG-INFO`
...
### Comparing `talan-0.1.4/setup.py` & `talan-0.1.4.4/setup.py`
...
### Comparing `talan-0.1.4/talan/_alan_calc.py` & `talan-0.1.4.4/talan/_alan_calc.py`
...
### Comparing `talan-0.1.4/talan/_alan_date.py` & `talan-0.1.4.4/talan/_alan_date.py`
...
### Comparing `talan-0.1.4/talan/_alan_mp4.py` & `talan-0.1.4.4/talan/_alan_mp4.py`

 * *Files identical despite different names*

### Comparing `talan-0.1.4/talan/_alan_ohlc_fcs.py` & `talan-0.1.4.4/talan/_alan_ohlc_fcs.py`
...
### Comparing `talan-0.1.4/talan/_alan_optparse.py` & `talan-0.1.4.4/talan/_alan_optparse.py`

 * *Files identical despite different names*

### Comparing `talan-0.1.4/talan/_alan_pppscf.py` & `talan-0.1.4.4/talan/_alan_pppscf.py`

 * *Files identical despite different names*

### Comparing `talan-0.1.4/talan/_alan_rmc.py` & `talan-0.1.4.4/talan/_alan_rmc.py`
...
### Comparing `talan-0.1.4/talan/_alan_str.py` & `talan-0.1.4.4/talan/_alan_str.py`
...
### Comparing `talan-0.1.4/talan/alanapi.py` & `talan-0.1.4.4/talan/alanapi.py`
...
### Comparing `talan-0.1.4/talan/csv2plotj2ts.py` & `talan-0.1.4.4/talan/csv2plotj2ts.py`
...
### Comparing `talan-0.1.4/talan/find_recent_eps.py` & `talan-0.1.4.4/talan/find_recent_eps.py`

 * *Files identical despite different names*

### Comparing `talan-0.1.4/talan/fredReader.py` & `talan-0.1.4.4/talan/fredReader.py`

 * *Files identical despite different names*

### Comparing `talan-0.1.4/talan/headline_calc.py` & `talan-0.1.4.4/talan/headline_calc.py`
...
### Comparing `talan-0.1.4/talan/headline_sts.py` & `talan-0.1.4.4/talan/headline_sts.py`

 * *Files identical despite different names*

### Comparing `talan-0.1.4/talan/iex_peers.py` & `talan-0.1.4.4/talan/iex_peers.py`

 * *Files identical despite different names*

### Comparing `talan-0.1.4/talan/lsi_daily.py` & `talan-0.1.4.4/talan/lsi_daily.py`

 * *Files identical despite different names*

### Comparing `talan-0.1.4/talan/macro_event_yh.py` & `talan-0.1.4.4/talan/macro_event_yh.py`

 * *Files identical despite different names*

### Comparing `talan-0.1.4/talan/plot_templates.py` & `talan-0.1.4.4/talan/plot_templates.py`
...
### Comparing `talan-0.1.4/talan/record_hilo.py` & `talan-0.1.4.4/talan/record_hilo.py`
...
### Comparing `talan-0.1.4/talan/talan_wrap.py` & `talan-0.1.4.4/talan/talan_wrap.py`
...
### Comparing `talan-0.1.4/talan/theme_list.py` & `talan-0.1.4.4/talan/theme_list.py`
...
### Comparing `talan-0.1.4/talan/ticker2label.py` & `talan-0.1.4.4/talan/ticker2label.py`
...
### Comparing `talan-0.1.4/talan/ticker_mapping.py` & `talan-0.1.4.4/talan/ticker_mapping.py`
...
### Comparing `talan-0.1.4/talan/upd_mapping_ticker.py` & `talan-0.1.4.4/talan/upd_mapping_ticker.py`

 * *Files identical despite different names*

### Comparing `talan-0.1.4/talan/webReader.py` & `talan-0.1.4.4/talan/webReader.py`
...
### Comparing `talan-0.1.4/talan/yh_chart.py` & `talan-0.1.4.4/talan/yh_chart.py`
...
### Comparing `talan-0.1.4/talan/yh_hist_batch.py` & `talan-0.1.4.4/talan/yh_hist_batch.py`
...
### Comparing `talan-0.1.4/talan/yh_predefined.py` & `talan-0.1.4.4/talan/yh_predefined.py`
...
### Comparing `talan-0.1.4/talan.egg-info/PKG-INFO` & `talan-0.1.4.4/talan.egg-info/PKG-INFO`
...
### Comparing `talan-0.1.4/talan.egg-info/SOURCES.txt` & `talan-0.1.4.4/talan.egg-info/SOURCES.txt`
