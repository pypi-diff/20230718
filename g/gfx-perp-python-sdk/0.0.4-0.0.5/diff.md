# Comparing `tmp/gfx_perp_python_sdk-0.0.4.tar.gz` & `tmp/gfx_perp_python_sdk-0.0.5.tar.gz`
...
## Comparing `gfx_perp_python_sdk-0.0.4.tar` & `gfx_perp_python_sdk-0.0.5.tar`
...
### Comparing `gfx_perp_python_sdk-0.0.4/LICENSE` & `gfx_perp_python_sdk-0.0.5/LICENSE`

 * *Files identical despite different names*

### Comparing `gfx_perp_python_sdk-0.0.4/gfx-perp-python-sdk/trader.py` & `gfx_perp_python_sdk-0.0.5/gfx-perp-python-sdk/trader.py`
