# Comparing `tmp/boto3-stubs-lite-1.28.3.post2.tar.gz` & `tmp/boto3-stubs-lite-1.28.4.tar.gz`
...
### Comparing `boto3-stubs-lite-1.28.3.post2/setup.py` & `boto3-stubs-lite-1.28.4/setup.py`
